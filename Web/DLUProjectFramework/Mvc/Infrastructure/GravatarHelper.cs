...
namespace DLUProjectFramework.Mvc
{
    ...
    {
        public static MvcHtmlString GetGravatar(this HtmlHelper helper, string email, int size, string link, string rating = "PG", string alt = "Gravatar", string title = "Gravatar", string cssClass = "gravatar")
        {

...
Date Created: 21/11/2014 10:48:00 AM
...
namespace DLUProjectMvc.Areas.Security.Controllers
{
    ...
    {
        private IServices<Portal> _service ;
        ...
        {
            return View(new Portal { PortalID = 0, LogoUrl = "/content/images/noimage.png" });
        }
        
        [HttpPost]
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Create(Portal model)
        {
        ...
        [HttpPost]
		 [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit(Portal model)
        {
             if (ModelState.IsValid)
            {

/* FileName: AccountGroupController.cs
Project Name: DLUProject
Date Created: 7/11/2014 12:04:38 AM
...
namespace DLUProjectMvc.Areas.Security.Controllers
{
    ...
    public class AccountGroupController : BaseController
    {
        ...
        public AccountGroupController(IServices<AccountGroup> service, AccountGroupExtension accountGroupExt, IServices<Systems>systemService)
        {
        ...
        [ValidateInput(false)]
        public ActionResult Create(AccountGroup model)
        {
        ...
        [HttpPost]
        public ActionResult Edit(AccountGroup model)
        {
             if (ModelState.IsValid)
            {
        ...
        public ActionResult PermissionAll( string GroupID,string SystemID)
        {
            ViewBag.SystemID = _systemService.All();
            ViewBag.AccountGroup = _service.All();
            int gId = -1;
        ...
        {
            int rs = _service.Delete(new AccountGroup { GroupID = id });
            if (rs > 0)
            {

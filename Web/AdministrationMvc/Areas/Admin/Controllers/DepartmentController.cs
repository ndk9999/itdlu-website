/* FileName: DepartmentController.cs
Project Name: DLUProject
Date Created: 20/11/2014 4:03:50 PM
...
namespace DLUProjectMvc.Areas.Admin.Controllers
{
    ...
    {
        private IServices<Department> _service ;
        private DepartmentExtension _departmentExt;
        public DepartmentController(IServices<Department> service, DepartmentExtension departmentExt)
        {
        ...
        public ActionResult Index(int? page, int? pageSize, string queryString)
        {
            ...
            var model = _departmentExt.GetAllDepartments(pageIndex, pageSize1, queryString);
            InitData();
        ...
        {
            InitData();
            return View(new Department { DepartmentID = -1, DateStarted = DateTime.Now });
        }

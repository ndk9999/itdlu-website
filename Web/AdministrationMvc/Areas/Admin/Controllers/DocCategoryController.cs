...
namespace DLUProjectMvc.Areas.Admin.Controllers
{
    ...
    {
        private IServices<DocCategory> _service ;
       private DocCategoryExtension _cateExt;

       public DocCategoryController(IServices<DocCategory> service, DocCategoryExtension cateExt)
        {
        ...
        public ActionResult Create(CategoryModel model)
        {
            ...
            {
                var category = Mapper.Map<DocCategory>(model);

/* FileName: ResourceCategoryController.cs
Project Name: DLUProject
Date Created: 2/3/2015 8:54:17 AM
...
namespace DLUProjectMvc.Areas.Admin.Controllers
{
    ...
    public class ResourceCategoryController : BaseController
    {
        private IServices<ResourceCategory> _service ;
        public ResourceCategoryController(IServices<ResourceCategory> service)
        {
        ...
        {
            return View(new ResourceCategory {});
        }

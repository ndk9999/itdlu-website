...
namespace DLUProjectMvc.Controllers
{
    ...
    public class DocFileAttachmentController : BaseController
    {
        private IServices<DocFileAttachment> _service ;
        ...
        {
            return View(new DocFileAttachment {});
        }
        
        [HttpPost]
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Create(DocFileAttachment model)
        {
        ...
        [HttpPost]
		 [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit(DocFileAttachment model)
        {
             if (ModelState.IsValid)
            {

...
namespace DLUProjectMvc.Areas.Admin.Controllers
{
    public class LoginController : Controller
    {
        ...
        public LoginController(AccountExtension accountService)
        {
        ...
        public ActionResult Recovery(LoginModel model)
        {
            ...
            if (userExists != null)
            {
                ...
                if (rs)
                {
                    string smtpHost = SettingOption.Get("SMTP_SERVER");
                    string smtpPassword = SettingOption.Get("SMTP_PASSWORD");
                    int smtpPort = SettingOption.Int("SMTP_PORT");
                    string smtpUsername = SettingOption.Get("SMTP_EMAIL");

...
namespace DLUProjectMvc.Areas.Admin.Controllers
{
    ...
    {
        private IServices<MediaAlbum> _service ;
        private MediaCategoryExtension _categoryService;
        public MediaAlbumController(IServices<MediaAlbum> service, MediaCategoryExtension categoryService)
        {
        ...
        [ValidateInput(false)]
        public ActionResult Create(MediaAlbum model)
        {
        ...
        [HttpPost]
		 [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit(MediaAlbum model)
        {
             if (ModelState.IsValid)
            {

...
Date Created: 10/11/2014 10:17:43 AM
...
namespace DLUProjectMvc.Areas.Admin.Controllers
{
    ...
    {
        private IServices<MediaCategory> _service;
        private MediaCategoryExtension _cateExt;
        public MediaCategoryController(IServices<MediaCategory> service, MediaCategoryExtension cateExt)
        {
        ...
        public ActionResult Create(CategoryModel model)
        {
            ...
            {
                var category = Mapper.Map<MediaCategory>(model);
        ...
        {
            int rs = _service.Delete(new MediaCategory { CategoryID = id });
            if (rs > 0)
            {

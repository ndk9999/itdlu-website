...
namespace DLUProjectMvc.Areas.Admin.Controllers
{
    ...
    {
        private IServices<GalleryCategory> _service;
        private GalleryCategoryExtension _cateExt;

        public GalleryCategoryController(IServices<GalleryCategory> service, GalleryCategoryExtension cateExt)
        {
        ...
        public ActionResult Create(CategoryModel model)
        {
            ...
            {
                var category = Mapper.Map<GalleryCategory>(model);

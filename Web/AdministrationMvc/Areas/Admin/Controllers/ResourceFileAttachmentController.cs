...
namespace DLUProjectMvc.Areas.Admin.Controllers
{
    ...
    public class ResourceFileAttachmentController : BaseController
    {
        private IServices<ResourceFileAttachment> _service ;
        ...
        {
            return View(new ResourceFileAttachment {});
        }
        
        [HttpPost]
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Create(ResourceFileAttachment model)
        {
        ...
        [HttpPost]
		 [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit(ResourceFileAttachment model)
        {
             if (ModelState.IsValid)
            {

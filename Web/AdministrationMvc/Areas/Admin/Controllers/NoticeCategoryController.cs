...
Date Created: 18/11/2014 6:53:55 PM
...
namespace DLUProjectMvc.Areas.Admin.Controllers
{
    ...
    public class NoticeCategoryController : BaseController
    {
        ...
        private IServices<NoticeCategory> _service;
        private NoticeCategoryExtension _cateExt;
        public NoticeCategoryController(IServices<NoticeCategory> service, NoticeCategoryExtension cateExt)
        {
        ...
        public ActionResult Create(CategoryModel model)
        {
            ...
            {
                var category = Mapper.Map<NoticeCategory>(model);

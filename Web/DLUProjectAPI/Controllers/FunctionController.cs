...
namespace DLUProject.API.Controllers
{
    ...
    {
        IServices<Function> _service;

        public FunctionController(IServices<Function> service)
        {
            this._service = service;
        }
        // GET api/account
        public JsonResponse<Function> Get()
        {
               // return new JsonResponse<string > { Success = true,  Data="Chao the gioi" };
              var items = _service.All();
              return new JsonResponse<Function> { Success = true, ListData = items };
        }

        // GET api/Category/5
        public JsonResponse<Function> Get(int id)
        {
            var model = _service.Get(id);
            return new JsonResponse<Function> { Success = model != null, Data = model };
        }

        // POST api/Category
        public JsonResponse Post([FromBody]Function value)
        {           
        ...
        // PUT api/Category/5
        public JsonResponse Put([FromBody]Function value)
        {           

...
namespace DLUProject.API.Controllers
{
    ...
    {
        public IServices<Document> _service { get; set; }
        public DocumentController(IServices<Document> service)
        {
            this._service = service;
        }
        // GET api/account
        public JsonResponse<Document> Get()
        {
            var items = _service.All();
            return new JsonResponse<Document> { Success = true, ListData = items };
        }

        // GET api/Document/5
        public JsonResponse<Document> Get(int id)
        {
            var model = _service.Get(id);
            return new JsonResponse<Document> { Success = model != null, Data = model };
        }

        // POST api/Document
        public JsonResponse Post([FromBody]Document value)
        {           
        ...
        // PUT api/Document/5
        public JsonResponse Put([FromBody]Document value)
        {           

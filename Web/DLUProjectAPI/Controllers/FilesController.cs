...
namespace DLUProject.API.Controllers
{
    ...
    {
        public IServices<Files> _service { get; set; }
        public FilesController(IServices<Files> service)
        {
            this._service = service;
        }
        // GET api/account
        public JsonResponse<Files> Get()
        {
            var items = _service.All();
            return new JsonResponse<Files> { Success = true, ListData = items };
        }

        // GET api/Files/5
        public JsonResponse<Files> Get(int id)
        {
            var model = _service.Get(id);
            return new JsonResponse<Files> { Success = model != null, Data = model };
        }

        // POST api/Files
        public JsonResponse Post([FromBody]Files value)
        {           
        ...
        // PUT api/Files/5
        public JsonResponse Put([FromBody]Files value)
        {           

...
namespace DLUProject.API.Controllers
{
    ...
    {
        public IServices<Resource> _service { get; set; }
        public ResourceController(IServices<Resource> service)
        {
            this._service = service;
        }
        // GET api/account
        public JsonResponse<Resource> Get()
        {
            var items = _service.All();
            return new JsonResponse<Resource> { Success = true, ListData = items };
        }

        // GET api/Resource/5
        public JsonResponse<Resource> Get(int id)
        {
            var model = _service.Get(id);
            return new JsonResponse<Resource> { Success = model != null, Data = model };
        }

        // POST api/Resource
        public JsonResponse Post([FromBody]Resource value)
        {           
        ...
        // PUT api/Resource/5
        public JsonResponse Put([FromBody]Resource value)
        {           

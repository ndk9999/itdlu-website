/* FileName: MediaAlbumController.cs
...
namespace DLUProject.API.Controllers
{
    ...
    {
        public IServices<MediaAlbum> _service { get; set; }
        public MediaAlbumController(IServices<MediaAlbum> service)
        {
            this._service = service;
        }
        // GET api/account
        public JsonResponse<MediaAlbum> Get()
        {
            var items = _service.All();
            return new JsonResponse<MediaAlbum> { Success = true, ListData = items };
        }

        // GET api/MediaAlbum/5
        public JsonResponse<MediaAlbum> Get(int id)
        {
            var model = _service.Get(id);
            return new JsonResponse<MediaAlbum> { Success = model != null, Data = model };
        }

        // POST api/MediaAlbum
        public JsonResponse Post([FromBody]MediaAlbum value)
        {           
        ...
        // PUT api/MediaAlbum/5
        public JsonResponse Put([FromBody]MediaAlbum value)
        {           

...
namespace DLUProject.API.Controllers
{
    ...
    {
        public IServices<DocType> _service { get; set; }
        public DocTypeController(IServices<DocType> service)
        {
            this._service = service;
        }
        // GET api/account
        public JsonResponse<DocType> Get()
        {
            var items = _service.All();
            return new JsonResponse<DocType> { Success = true, ListData = items };
        }

        // GET api/DocType/5
        public JsonResponse<DocType> Get(int id)
        {
            var model = _service.Get(id);
            return new JsonResponse<DocType> { Success = model != null, Data = model };
        }

        // POST api/DocType
        public JsonResponse Post([FromBody]DocType value)
        {           
        ...
        // PUT api/DocType/5
        public JsonResponse Put([FromBody]DocType value)
        {           

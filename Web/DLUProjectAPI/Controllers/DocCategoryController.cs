/* FileName: DocCategoryController.cs
...
{
    public class DocCategoryController : ApiController
    {
        public IServices<DocCategory> _service { get; set; }
        public DocCategoryController(IServices<DocCategory> service)
        {
            this._service = service;
        }
        // GET api/account
        public JsonResponse<DocCategory> Get()
        {
            var items = _service.All();
            return new JsonResponse<DocCategory> { Success = true, ListData = items };
        }

        // GET api/DocCategory/5
        public JsonResponse<DocCategory> Get(int id)
        {
            var model = _service.Get(id);
            return new JsonResponse<DocCategory> { Success = model != null, Data = model };
        }

        // POST api/DocCategory
        public JsonResponse Post([FromBody]DocCategory value)
        {           
        ...
        // PUT api/DocCategory/5
        public JsonResponse Put([FromBody]DocCategory value)
        {           

...
namespace DLUProject.API.Controllers
{
    ...
    {
        public IServices<GalleryCategory> _service { get; set; }
        public GalleryCategoryController(IServices<GalleryCategory> service)
        {
            this._service = service;
        }
        // GET api/account
        public JsonResponse<GalleryCategory> Get()
        {
            var items = _service.All();
            return new JsonResponse<GalleryCategory> { Success = true, ListData = items };
        }

        // GET api/GalleryCategory/5
        public JsonResponse<GalleryCategory> Get(int id)
        {
            var model = _service.Get(id);
            return new JsonResponse<GalleryCategory> { Success = model != null, Data = model };
        }

        // POST api/GalleryCategory
        public JsonResponse Post([FromBody]GalleryCategory value)
        {           
        ...
        public JsonResponse Put([FromBody]GalleryCategory value)
        {           

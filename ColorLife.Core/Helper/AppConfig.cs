...
namespace ColorLife.Core.Helper
{
    ...
    public class AppConfig : AppSettingsReader
    {
        ...
        {
            return ConvertType.ToInt(System.Configuration.ConfigurationManager.AppSettings[key]);
        }
        public bool Boolean(string key)
        {
            return ConvertType.ToBool(System.Configuration.ConfigurationManager.AppSettings[key]);
        }
        /// <summary>
        /// 
        /// </summary>

...
namespace DLUProject.Data
{
    ...
    /// </summary>
    public partial class BLRepository<T> : IRepository<T> where T : class
    {
        private DataContext _dbContext;  
        
        public BLRepository(BLDataContext dataContext)
        {
        ...
        //DataContext CreateConnection(BLDataContext dataContext)
        //{
        //    _dbContext = dataContext;
        //    return _dbContext;
        //}
